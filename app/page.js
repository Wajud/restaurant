...
import foods from "@/app/assets/foods.jpg"
import drinks from "@/app/assets/drinks.jpg"
  ...
  return (
    ...
    <div className="absolute top-0 left-0 w-full h-[70vh] bg-[rgba(0,0,0,0.7)] z-20"></div>
      ...
      <div className="absolute top-0 left-0 w-full h-[70vh]  z-30 flex flex-col justify-center items-center text-white">
        <h1 className="text-5xl text-center  font-bold text-red-400 max-w-[90%] mx-auto">Welcome to Holmes Hotel</h1>
        <p className="text-center py-4 max-w-[90%] mx-auto">Experience luxury and comfort at our hotel. Elegant rooms, exceptional service and a relaxing ambiance await you.</p>
      </div>
    </div>
    ...
    <div className="w-[95%] md:w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 items-stretch">
      <Link href={"/foods"} className="block w-full bg-gray-100 h-full shadow-md p-8 transition-all hover:scale-105 rounded-md">
      <div className="flex flex-col items-center text-center py-8 ">
        <Image src={foods} className="w-40 h-40 rounded-full" alt="food image" />
      ...
      <Link href={"/drinks"} className="block w-full bg-gray-100 h-full shadow-md p-8 transition-all hover:scale-105 rounded-md">
      <div className="flex flex-col items-center text-center py-8">
        <Image src={drinks} className="w-40 h-40 rounded-full" alt="drinks image" />
